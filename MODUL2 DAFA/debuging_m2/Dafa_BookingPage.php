...
<body style="background-color: whitesmoke;">
    <nav class="navbar-light fixed-top " style="background-color:#607EAA;" >
        <ul class="nav justify-content-center">
          ...
          <li class="nav-item ">
            ...
            <a class="nav-link active text-light" href="Dafa_Home.php">
              Home
            </a>
            </h6>
          </li>
          <li class="nav-item ">
            <h6 style="text-align: center;color:antiquewhite">
            <a class="nav-link active text-light" href="Dafa_BookingPage.php">
              Booking
            </a>
            </h6>
          </li>
                  ...
                  <div class="col-md-5">
                      <from action="MyBooking.php" method="GET">
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="Name" value="Dafa_1202204206" readonly>
                          </div>
  ...
  <footer class="bg-light text-center text-lg-start fixed-bottom">
    <div class="text-center p-2" style="background-color:#607EAA">
    <h6 style="text-align: center;color:white">
      Created by Dafa_1202204206
    </div>
  </footer>
</body>
</html>