            ...
            <div class="col-4">
                <form method="post" action="config/check_login.php">
                    ...
                    <label class="form-check-label" for="exampleCheck1">Belum punya akun? <a
                            href="register_dafa.php">Register</a></label>
                </form>
            </div>
        </div>
    </div>
    ...
    <div class="footer">
        <div class="row">
            <div class="col" style="text-align: center; margin-top: 10px;">
                <span class="text text-white">&copy;2022 Copyright: <a href="#" data-bs-toggle="modal" data-bs-target="#nimModal">DAFA ANDIKA_1202204206</a></span>
            </div>
        </div>
    </div>
