...
include 'config/koneksi.php';
  ...
  if (isset($_GET['id_mobil'])) {
    ...
    $query = "SELECT * FROM showroom_dafa_table WHERE id_mobil='$id_mobil'";
    ...
    if (!count($data)) {
        echo "<script>alert('Data tidak ditemukan pada database');window.location='myitem_dafa.php';</script>";
       }
  } else {
    // apabila tidak ada data GET id pada akan di redirect ke index.php
    echo "<script>alert('Masukkan data id');window.location='myitem_dafa.php';</script>";
  }         
  ?>
<!doctype html>
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="home_dafa.php">Home</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="myitem_dafa.php">My Car</a>
                </li>
