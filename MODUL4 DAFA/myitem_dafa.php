...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top">
        <div class="container-fluid">
            ...
            <form class="d-flex justify-content-end" action="#">
                <a href="additem_dafa.php" class="btn btn-light">Add car</a>
            </form>
            </div>
        </div>
    </nav>
    ...
    <div class="container p-5">
        ...
        <!-- read -->
            <div class="row g-2">
            <?php
                $sql = "SELECT * FROM showroom_dafa_table ORDER BY id_mobil ASC";
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-start">
                                <div class="row">
                                    <div class="col">
                                        <a href="detail_dafa.php?id_mobil=<?php echo $mycar['id_mobil'];?>" class="btn btn-primary rounded-4">Detail</a>
                                    </div>
                                    <div class="col">
